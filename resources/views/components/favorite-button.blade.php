...
>
    ...
    <button
        ...
        data-label-liked="Remove from liked services"
        data-label-unliked="Add to liked services"
    >
        <svg xmlns="http://www.w3.org/2000/svg" class="{{ $iconSizeMap[$size] ?? $iconSizeMap['default'] }}" viewBox="0 0 24 24" fill="{{ $isLiked ? 'currentColor' : 'none' }}" stroke="currentColor" stroke-width="1.8" data-favorite-icon>
