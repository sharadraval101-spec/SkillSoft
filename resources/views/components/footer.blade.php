...
<footer class="mt-16 border-t border-black/5 bg-white" data-motion-footer>
    <div class="mx-auto max-w-[1280px] px-4 py-8 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <a href="{{ $homeHref }}" class="inline-flex shrink-0 items-center gap-3 text-zinc-950 leading-none" data-motion-brand>
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-3 text-sm font-medium text-zinc-600">
                <a href="{{ $homeHref }}" class="transition hover:text-zinc-950" data-motion-link>Home</a>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="#" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 text-zinc-500 transition hover:border-zinc-950 hover:text-zinc-950" aria-label="Facebook" data-motion-social data-motion-action>
                ...
                <a href="#" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 text-zinc-500 transition hover:border-zinc-950 hover:text-zinc-950" aria-label="X" data-motion-social data-motion-action>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="#" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 text-zinc-500 transition hover:border-zinc-950 hover:text-zinc-950" aria-label="LinkedIn" data-motion-social data-motion-action>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="mt-6 border-t border-black/5 pt-5 text-sm text-zinc-500">
            <p>&copy; {{ now()->year }} SkillSlot. All rights reserved.</p>
        </div>
    </div>
</footer>
