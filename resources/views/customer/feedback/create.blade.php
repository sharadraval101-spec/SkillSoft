...
<section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8" id="customer-feedback-create-page" data-motion-section>
    <section class="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-[0_28px_80px_-40px_rgba(15,23,42,0.18)] sm:p-8" data-motion-card>
        <div class="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            <div class="max-w-3xl">
                ...
                <h1 class="mt-3 text-4xl font-semibold tracking-[-0.05em] text-zinc-950 sm:text-[3rem]">Rate your completed service</h1>
                <p class="mt-4 text-[15px] leading-8 text-zinc-500">
                    Share a rating for the finished booking, add a short headline if you want, and describe the experience in your own words. Submitted feedback cannot be edited later.
                </p>
            </div>
    ...
    <div class="mt-6 grid gap-6 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.15fr)]">
        ...
        <section class="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-[0_28px_80px_-40px_rgba(15,23,42,0.18)] lg:p-8" data-motion-card>
            <div>
                ...
                <h2 class="mt-2 text-2xl font-semibold tracking-[-0.04em] text-zinc-950">Tell us how it went</h2>
            ...
            <form method="POST" action="{{ route('customer.feedback.store', $booking) }}" class="mt-8 space-y-7">
                @csrf
                ...
                <div class="rounded-[1.35rem] border border-zinc-200 bg-zinc-50 px-4 py-4 text-sm leading-7 text-zinc-600">
                    Your feedback is tied to booking <span class="font-semibold text-zinc-950">{{ $booking->booking_number }}</span>, helps keep service ratings trustworthy and useful, and can only be submitted once.
                </div>
